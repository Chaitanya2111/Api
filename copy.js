...
// // app.get("/api/tenderdetails", async (req, res) => {
// //   try {
// //     const pool = await sql.connect(config);
// //     const result = await pool.request().query("SELECT * FROM Tbl_Tender");
// //     res.json(result.recordset);
...
// //   try {
// //     const pool = await sql.connect(config);
// //     const result = await pool.request().query("SELECT * FROM Tbl_TenderFile");
// //     res.json(result.recordset);
// //   } catch (err) {
// //     console.error(err);
// //     res.status(500).send("Internal Server Error");
...
// // app.get("/api/tenderquestions", async (req, res) => {
// //   try {
// //     const pool = await sql.connect(config);
// //     const result = await pool.request().query("SELECT * FROM Tbl_TenderQueAns");
// //     res.json(result.recordset);
// //   } catch (err) {
// //     console.error(err);
// //     res.status(500).send("Internal Server Error");
...
// //     const pool = await sql.connect(config);
// //     const insertQuery = `
// //       INSERT INTO Tbl_Tender_Vender_Mapping (TenderNumber, Tend_Que, Tend_Ans)
// //       VALUES (@TenderNumber, @Tend_Que, @Tend_Ans)
// //     `;
...
// //     try {
// //       for (const { TenderNumber, Tend_Que, Tend_Ans } of answers) {
// //         await transaction
// //           .request()
// //           .input("TenderNumber", sql.NVarChar, TenderNumber)
// //           .input("Tend_Que", sql.NVarChar, Tend_Que)
// //           .input("Tend_Ans", sql.NVarChar, Tend_Ans)
// //           .query(insertQuery);
// //       }

// //       await transaction.commit();
// //       res.json({ message: "Answers submitted successfully to Tbl_Tender_Vender_Mapping" });
// //     } catch (error) {
// //       await transaction.rollback();
// //       throw error;
// //     }
...
// //   return (
// //     item.Qnty * item.Rate +
// //     (item.Qnty * item.Rate * (item.Tax1Rate + item.Tax2Rate)) / 100
// //   );
// // };
// // app.post("/api/update_tenders", async (req, res) => {
// //   try {
// //     await sql.connect(config);

// //     for (const tender of req.body.tenders) {
// //       const totalAmount = calculateRowTotal(tender);
// //       await sql.query`
// //         UPDATE Tbl_TenderItem
// //         SET
// //           Rate = ${tender.Rate},
// //           Tax1Name = ${tender.Tax1Name},
// //           Tax1Rate = ${tender.Tax1Rate},
// //           Tax2Name = ${tender.Tax2Name},
// //           Tax2Rate = ${tender.Tax2Rate},
...
// //     res
// //       .status(200)
// //       .json({ success: true, message: "Tenders updated successfully" });
// //   } catch (error) {
...
//       .request()
//       // .query('SELECT ID, InvoiceNo, InvoiceDate, Expiry_Date, TotalAmount, Status FROM Tbl_Invoice');
...
// app.get("/api/getestimate", async (req, res) => {
//   try {
//     const pool = await sql.connect(config);
//     const result = await pool
//       .request()
//       // .query('SELECT ID, EstimateNo, EstimateDate, Expiry_Date, TotalAmount, Status FROM Tbl_Estimate');
//       .query("SELECT * FROM Tbl_Estimate");
//     res.json(result.recordset);
//   } catch (error) {
//     console.error("Error fetching invoice data:", error);
//     res.status(500).send("Internal Server Error");
...
// //   try {
// //     const pool = await sql.connect(config);
// //     const result = await pool.request().query("SELECT * FROM Tbl_contracts");
// //     res.json(result.recordset);
// //   } catch (error) {
// //     console.error("Error fetching project data:", error);
// //     res.status(500).json({ error: "Internal Server Error" });
...
//       .query(
//         "SELECT * FROM Tbl_contractsVendor WHERE id = @id"
//       );
...
// // app.get("/api/tender_ratesedit", async (req, res) => {
// //   try {
// //     const pool = await sql.connect(config);
// //     const result = await pool
// //       .request()
// //       .query("SELECT * FROM Tbl_TenderItemVendor");
// //     res.json(result.recordset);
// //   } catch (err) {
// //     console.error(err);
// //     res.status(500).send("Internal Server Error");
...
//   try {
//     const { TenderNo } = req.params;
//     const { tenders, vendorID, totalItemAmount, totalTaxAmount, grandTotalAmount } = req.body;
//     const pool = await sql.connect(config);
...
//           .input("Tax2Name", sql.NVarChar(230), tender.Tax2Name)
//           .input("Tax2Rate", sql.Float, tender.Tax2Rate)
//           .input("TotalAmont", sql.Float, tender.TotalAmont)
//           .query(`
//             UPDATE Tbl_TenderItemVendor
//             SET
...
// // app.post("/api/insert_tenders", async (req, res) => {
// //   try {
// //     const { tenders } = req.body;
// //     const pool = await sql.connect(config);
...
// //       (TenderNumber,  CustomerID, ProjectID, Item, Description, Qnty, Rate, Tax1Name, Tax1Rate, Tax2Name, Tax2Rate, TotalAmont)
// //       VALUES
// //       (@TenderNumber,  @CustomerID, @ProjectID, @Item, @Description, @Qnty, @Rate, @Tax1Name, @Tax1Rate, @Tax2Name, @Tax2Rate, @TotalAmont)
// //     `);
// //     }
...
//         .input("TotalAmont", sql.Float, tender.TotalAmont).query(`
//       INSERT INTO Tbl_TenderItemVendor
//       (TenderNumber, vendorID,CustomerID, ProjectID, Item, Description, Qnty, Rate, Tax1Name, Tax1Rate, Tax2Name, Tax2Rate, TotalAmont)
//       VALUES
//       (@TenderNumber,@vendorID, @CustomerID, @ProjectID, @Item, @Description, @Qnty, @Rate, @Tax1Name, @Tax1Rate, @Tax2Name, @Tax2Rate, @TotalAmont)
//     `);
//     }
...
// // app.get("/api/tendergetret", async (req, res) => {
// //   try {
// //     const pool = await sql.connect(config);
// //     const result = await pool
// //       .request()
...
// // app.post("/api/store_totals", async (req, res) => {
// //   try {
// //     const {
// //       Tend_id,
// //       Vend_id,
...
// //     await pool
// //       .request()
// //       // .input("Tend_id", sql.Float, Tend_id)
// //       // .input("Vend_id", sql.Float, Vend_id)
...
// //       (TenderNumber, TotalSubTotal, TotalTaxTotal, TotalAmountTender)
// //       VALUES
// //       (@TenderNo, @TotalItemAmount, @TotalTaxAmount, @GrandTotalAmount)
// //     `);
...
// // app.put("/api/update_grand_total", async (req, res) => {
// //   const { TenderNo, grandTotalAmount } = req.body;

// //   try {
// //     const request = pool.request();

// //     // Update the TotalAmount in the tbl_tender table based on TenderNo
// //     const query = `
// //       UPDATE Tbl_Tender
// //       SET TotalAmount = @grandTotalAmount
// //       WHERE TenderNo = @TenderNo
// //     `;

// //     await request.input("grandTotalAmount", sql.Float, grandTotalAmount);
// //     await request.input("TenderNo", sql.NVarChar, TenderNo);

// //     const result = await request.query(query);

// //     console.log("TotalAmount updated successfully");
// //     res.status(200).send("TotalAmount updated successfully");
// //   } catch (error) {
...
// //       const updateLastLoginResult = await pool
// //         .request()
// //         .input("email", sql.NVarChar, email)
// //         .query(
// //           "UPDATE Tbl_contactsVendor SET LastLoginDateTime = GETDATE() WHERE Email = @email"
// //         );

// //       if (updateLastLoginResult.rowsAffected[0] > 0) {
// //         console.log("Last login date and time updated successfully");
// //       } else {
// //         console.log("Failed to update last login date and time");
// //       }
...
//       .input('email', sql.NVarChar, email)
//       .input('password', sql.NVarChar, password)
//       .query("SELECT Vender_id, email FROM Tbl_contactsVendor WHERE email = @email AND password = @password");
...
//       req.session.Vender_id = userData.Vender_id;
...
// //     const result = await pool
// //       .request()
// //       .query("SELECT * FROM Tbl_contactsVendor");
// //     res.json(result.recordset);
// //   } catch (err) {
// //     console.error(err);
// //     res.status(500).send("Internal Server Error");
...
//       .query("SELECT COUNT(*) AS count FROM Tbl_contactsVendor WHERE Email = @email AND Password = @oldPassword");
...
//       .query("UPDATE Tbl_contactsVendor SET Password = @newPassword WHERE Email = @email");
...
//       .input('vendorId', sql.Int, vendorId)
//       .query('UPDATE Tbl_contactsVendor SET email = @email, phonenumber = @phonenumber, firstname = @firstname, lastname = @lastname WHERE Vender_id = @vendorId');
...
// // app.get("/api/allocated-tenders", async (req, res) => {
// //   try {
// //     const pool = await sql.connect(config);
...
// //         WHERE Tbl_Tender_Vender_Calculation.Apply = 1
// //       `);
...
// // app.get("/api/published-tenders", async (req, res) => {
// //   try {
// //     const pool = await sql.connect(config);
// //     const result = await pool.request().query(`
// //         SELECT
...
// // app.get("/api/applied-tenders", async (req, res) => {
// //   try {
// //     const pool = await sql.connect(config);
// //     const result = await pool.request().query(`
// //         SELECT
...
// // app.post("/api/submitanswers", async (req, res) => {
// //   try {
// //     const { answers, tenderNumber } = req.body;
...
// //     try {
// //       for (const { Tend_Que, Tend_Ans } of answers) {
// //         await transaction
// //           .request()
// //           .input("TenderNumber", sql.NVarChar, tenderNumber)
// //           .input("Tend_Que", sql.NVarChar, Tend_Que)
...
// //       await transaction.commit();
// //       res.json({
// //         message: "Answers submitted successfully to Tbl_Tender_Vender_Mapping",
// //       });
// //     } catch (error) {
// //       await transaction.rollback();
// //       throw error;
...
// // app.post(
// //   "/api/submitanswers/:tenderNumber",
...
// //       const query = `
// //       INSERT INTO Tbl_Tender_Vender_Mapping ( TenderNumber, Tend_Que, Tend_Ans, Doc_File, Doc_Filepath, Status, CreateDate, UpdateDate, LogInType)
// //       VALUES ( @TenderNumber, @Tend_Que, @Tend_Ans, @Doc_File, @Doc_Filepath, @Status, @CreateDate, @UpdateDate, @LogInType);
// //     `;
...
// //           await transaction
// //             .request()
// //             .input("Tend_id", sql.Int )
// //             .input("Vend_id", sql.Int)
// //             .input("TenderNumber", sql.NVarChar(200), tenderNumber)
...
// //     const result = await pool
// //       .request()
// //       .input("InvoiceNo", sql.NVarChar(200), req.params.InvoiceNo)
// //       .query(`
// //         SELECT
...
// //         .request()
// //         .input("InvoiceID", sql.Int, invoiceDetails.ID)
// //         .query(`
// //         SELECT
// //           Filename,
// //           Filepath
...
// //       const itemsResult = await pool
// //         .request()
// //         .input("InvoiceNumber", sql.NVarChar(200), req.params.InvoiceNo)
// //         .query(`
// //           SELECT
// //             Description,
// //             Item,
...
// //     const result = await pool
// //       .request()
// //       .input("EstimateNo", sql.NVarChar(200), req.params.EstimateNo)
// //       .query(`
// //         SELECT
...
// //       const fileResult = await pool
// //         .request()
// //         .input("EstimateID", sql.Int, estimateDetails.ID)
// //         .query(`
// //    SELECT
// //      Filename,
// //      Filepath
...
//         .input("email", sql.NVarChar, email)
//         .query(
//           "UPDATE Tbl_contacts SET last_login = GETDATE() WHERE Email = @email"
//         );
...
//         SELECT
//           Tbl_Tender.TenderNo,
//           Tbl_Work_Order_Calculation.TenderNumber,
//           Tbl_Work_Order_Calculation.TenderName,
//           Tbl_Work_Order_Calculation.OrderPublish,
//           Tbl_Work_Order_Calculation.TenderBased,
//           Tbl_Work_Order_Calculation.AddCity,
//           Tbl_Work_Order_Calculation.Description,
//           Tbl_Work_Order_Calculation.Pincode,
//           Tbl_Work_Order_Calculation.AuthorityName,
//           Tbl_Work_Order_Calculation.Authorityaddress,
//           Tbl_Work_Order_Calculation.Auth_Email,
//           Tbl_Work_Order_Calculation.Auth_Position,
//           Tbl_Work_Order_Calculation.Auth_Contact,
//           Tbl_Work_Order_Calculation.TotalAmountTender,
//           Tbl_Work_Order_Calculation.EndDate,
//           Tbl_Work_Order_Calculation.Publishdate,
//           Tbl_Work_Order_Calculation.Estimatecontractvalue,
//           Tbl_Work_Order_Calculation.Client_Note,
//           Tbl_Work_Order_Calculation.Term_condition,
//           Tbl_Work_Order_Calculation.StartDate,
//           Tbl_Work_Order_Calculation.Publishdate,
//           Tbl_Work_Order_Calculation.WorkOrderNumber,
//           Tbl_Work_Order_Calculation.Vend_id
//         FROM Tbl_Tender
//         INNER JOIN Tbl_Work_Order_Calculation
//         ON Tbl_Tender.TenderNo = Tbl_Work_Order_Calculation.TenderNumber
//         WHERE Tbl_Work_Order_Calculation.OrderPublish = 1 AND   Tbl_Work_Order_Calculation.Vend_id=@vendorID
//       `);
...
//       .input("vendorID", sql.Int, vendorID).query(`
//         SELECT * FROM Tbl_Work_Order_Calculation WHERE OrderPublish = 1 AND  Vend_id=@vendorID
//       `);
...
// app.get("/api/workorderdetail-tenders/:vendorID", async (req, res) => {
//   try {
//     const { vendorID } = req.params;
//     const pool = await sql.connect(config);
//     const result = await pool.request().input("vendorID", sql.Int, vendorID)
...
//     console.log("SQL Query Parameters:", WorkOrderNumber);
//     res.json(result.recordset);
//   } catch (error) {
//     console.error("Error fetching tender questions:", error);
//     res.status(500).json({ error: "Internal Server Error" });
...
// app.post("/saveTicket", upload.single("attachment"), async (req, res) => {
//   let pool;
//   try {
...
//          Attachment Path: ${req.file ? req.file.path : ''}
//       `,
//     };

//     const profileResponse = await pool.request()
//   .input("venderId", sql.NVarChar, raiseId) // Change to "Vender_id"
//   .query("SELECT email FROM Tbl_contactsVendor WHERE vender_id = @venderId"); // Change to "@Vender_id"

//     const customerEmail = profileResponse.recordset[0].email; // Assuming the email is retrieved from the profile

//     // Now you can use customerEmail in your customerMailOptions
...
//       .input("tickFile", sql.NVarChar, req.file.filename)
//       .input("tickFilePath", sql.NVarChar, req.file.path)
//       .input("extension", sql.NVarChar, req.file.mimetype)
//       .input("raiseBy", sql.NVarChar, raiseName)
...
//       .request()
//       .query(
//         "SELECT TOP 1 Ticket_Number FROM Tbl_Support_Ticket ORDER BY Ticket_Number DESC"
//       );

//     let lastTicketNumber =
//       result.recordset[0].Ticket_Number || "2024-11:TICKET-00000"; // Get the last ticket number from the database
//     const numericSuffix = parseInt(lastTicketNumber.split("-")[1]); // Extract the numeric suffix
//     const newNumericSuffix = numericSuffix + 1; // Increment the numeric suffix
//     const paddedNewNumericSuffix = String(newNumericSuffix).padStart(5, "0"); // Pad the numeric suffix with leading zeros

//     const currentDate = new Date();
//     const year = currentDate.getFullYear();
//     const month = (currentDate.getMonth() + 1).toString().padStart(2, "0");
//     const newTicketNumber = `${year}-${month}:TICKET-${paddedNewNumericSuffix}`; // Construct the new ticket number
...
//     const sqlQuery = `INSERT INTO CCTV (Count, Type, Date_Time) VALUES (@Count, @Type, @Date_Time)`;
//     request.input('Count', sql.Int, postData.Count);
//     request.input('Type', sql.NVarChar, postData.Type);
//     request.input('Date_Time', sql.DateTime, postData.Date_Time);
...
//       .request()
//       .input('vendorId', sql.Int, vendorId)
//       .query("SELECT * FROM Tbl_createinvoices WHERE vendor_id = @vendorId");
//     res.json(result.recordset);
//   } catch (error) {
//     console.error("Error fetching invoice data:", error);
//     res.status(500).send("Internal Server Error");
...
app.get("/api/getsupportdetail/:Ticket_Number", async (req, res) => {
  try {
    const { Ticket_Number } = req.params;
    const pool = await sql.connect(config);
    const result = await pool
      .request()
      .input("Ticket_Number", sql.NVarChar(200), Ticket_Number)
      .query(
        "SELECT * FROM [Tbl_Support_Ticket] WHERE Ticket_Number = @Ticket_Number"
      );
